		...
		<div class="container" data-aos="fade-up">
			...
			<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
				...
				<!-- <div class="col-lg-4 col-md-6 portfolio-item filter-app">
					<div class="portfolio-wrap">
						...
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Aaroyan Foundation.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-web">
					<div class="portfolio-wrap">
						<img src="/img/portfolio/Bino Brokers.png" class="img-fluid" alt="">
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Bino Brokers.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-app">
					<div class="portfolio-wrap">
						<img src="/img/portfolio/Dhanji-Logo-Board.png" class="img-fluid" alt="">
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Dhanji-Logo-Board.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 2"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-card">
					<div class="portfolio-wrap">
						<img src="/img/portfolio/Flavia-1-6-1.png" class="img-fluid" alt="">
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Flavia-1-6-1.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 2"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-app">
					<div class="portfolio-wrap">
						...
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Video-24.mp4" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-app">
					<div class="portfolio-wrap">
						...
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Video-21.mp4" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-web">
					<div class="portfolio-wrap">
						<img src="/img/portfolio/Hari-Glass.png" class="img-fluid" alt="">
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Hari-Glass.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Web 2"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-app">
					<div class="portfolio-wrap">
						<img src="/img/portfolio/Local-Findy.jpg" class="img-fluid" alt="">
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Local-Findy.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 3"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-card">
					<div class="portfolio-wrap">
						<img src="/img/portfolio/Marwar Buildcon.png" class="img-fluid" alt="">
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Marwar Buildcon.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 1"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-app">
					<div class="portfolio-wrap">
						...
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Video-1.mp4" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-card">
					<div class="portfolio-wrap">
						<img src="/img/portfolio/Vally Interior.jpg" class="img-fluid" alt="">
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Vally Interior.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 3"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 portfolio-item filter-app">
					<div class="portfolio-wrap">
						...
						<div class="portfolio-info">
							<h4>Logo Type</h4>
							<div class="portfolio-links">
								<a href="/img/portfolio/Video-11.mp4" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
							</div>
						</div>
					</div>
				</div> -->
