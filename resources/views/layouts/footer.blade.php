			...
			<div class="row">
				<div class="col-xl-4 col-lg-6">
					<div class="footer-info">
						...
						<p class="pe-md-5">We believe that quality and modernity go hand-in-hand to create truly impactful visuals that stand out from the crowd and captivate your target audience.<br><br></p>
					</div>
				</div>
				<div class="col-xl-5 col-lg-6 footer-links">
					<h4>Our Services</h4>
					<ul class="row">
				...
				<div class="col-xl-3 footer-newsletter">
					<h4>Contact Us</h4>
